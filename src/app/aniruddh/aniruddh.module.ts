...
@NgModule({
  ...
  declarations: [DownloadComponent, HomeComponent, WorkSampleComponent, ContactsComponent, ReferenceComponent, SummaryComponent, ExperienceComponent, ReferenceWebsitesComponent, EducationsComponent, HonorsAndAwardsComponent, ProjectsComponent]
})
